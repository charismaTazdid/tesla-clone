...
const Interior = styled.div`
    height: 80vh;
    width: 100vw;
    background-image: url("/images/model-s-Img/5.jfif");
...
const ImageContainer = styled.div`
    ...
    background-image: url("/images/model-s-Img/4.jfif");
    background-size: cover;
    background-position: center;
...
const Wrap = styled.div`
    width: 100vw;
    height: 100vh;
    background-image: url("/images/model-s-Img/1.jfif");
